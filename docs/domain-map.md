...
**Ledger:** [`docs/bugs.md`](bugs.md). Bug 1 filed 24 Sep (Active 90d vs 11 Active Customers). Bug 2 filed 25 Sep (`contact_type` vs `roles`, `94be1601-6dd1-4ade-a01c-38317e39d9a1`). Bug 3 filed 26 Sep (`a9a923b6-ce45-482f-8f8b-3aebabc9ee03`). Bug 4 filed 26 Sep (`d8ec8e3e-a74a-4a6b-9b9b-e858983d1b15`).
